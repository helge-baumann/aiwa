...
fig <- leaflet_basis(geo) %>% 
  leaflet_text("Teenagermutterschaften in Deutschland", size=20, group="2020") %>%
  leaflet_text(lat=55.25, 
               "Geburten unter 1.000 15- bis 19-Jährigen (2020)", size=15) %>%
  ...
  leaflet_polygons(
    ...
    variablen=c("Anteil (2020)", "Anzahl (2020)", "SGB-II-Quote (2020)"),
    headers=c("Teenagermutterschaften (2020)", "Anzahl Geburten (2020)", "SGB-II-Quote (2020)"),
