...
check1 <- ggplot(geo2, aes(x=long, y=lat, group=group)) +
  ggtitle("Geringfügig entlohnte Beschäftigte im Nebenjob, Juni 2019") +
...
pdf(file=paste0("./Output/Karten/", name_mjn, ".pdf"), 
