...
check1 <- ggplot(geo2, aes(x=long, y=lat, group=group)) +
  ggtitle("Befristete Einstellungen, Juni 2019") +
...
pdf(file=paste0("./Output/Karten/", name_bef, ".pdf"), 
