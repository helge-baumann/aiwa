...
colfunc <- colorRampPalette(farben(col_vol))
...
check1 <- ggplot(geo2, aes(x=long, y=lat, group=group)) +
  labs(
    title="Standard-Arbeitsvolumen pro Arbeitnehmer nach Kreisen und Wirtschaftsbereichen",
    subtitle="Geleistete Arbeitsstunden 2018") +
...
pdf(file=paste0("./Output/Karten/", name_vol, ".pdf"), 
