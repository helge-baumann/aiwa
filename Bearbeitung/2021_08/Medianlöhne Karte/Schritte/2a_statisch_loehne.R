...
geo <- merge(geo, dat_gesamt, by=key) # dat siehe 1_read.R
...
karte <- static_map(
  geo,
  titel = "Bruttolöhne, Dezember 2020", 
  untertitel = "Mittlere monatliche Bruttoarbeitsentgelte ..., in Euro", 
  caption = "", leg = "") 
...
pdf(file=paste0("./Output/Karten/", name_s1, ".pdf"), width=4, height=7)
print(karte)
dev.off()
