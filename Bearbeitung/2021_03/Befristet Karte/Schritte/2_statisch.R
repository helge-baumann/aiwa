...
geo <- merge(geo, dat20, by=key) # dat siehe 1_read.R
...
karte <- static_map(
  geo,
  titel = "Befristete Einstellungen, Juni 2020", 
  untertitel = "Anteil befristeter Einstellungen an allen Einstellungen in \n der SvB-Kerngruppe, in Prozent", 
  caption = "", leg = "") 
