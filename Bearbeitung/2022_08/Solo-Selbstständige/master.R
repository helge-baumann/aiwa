...
library(pacman)
p_load("stringr", "haven", "sp", "rgdal", "leaflet", "styler", "tidyr",
       "geosphere", "htmltools", "ggplot2", "ggmap", "rgeos", "maptools", 
       "openxlsx","extrafont", "htmlwidgets", "leaflet.extras", "dplyr",
       "scales", "widgetframe", "rmapshaper", "udunits2") # rgeos vor maptools!
loadfonts()

# (2) Definitionen----

# Ebene? 
ebene <- "LAN" # KRS, AMR, LAN
key <- "GEN" # analog zu ebene: AGS, AMR, GEN

# Dateinamen
# Name für statische Kreis-Karte
name_s <- paste0("wsi_aiwa_solo_selbstaendige")
# Name für interaktive Kreis-Karte
name_i <- paste0("wsi_aiwa_solo_selbstaendige")
